...
class NewsController extends FrontendController
{
    ...
    public function group(){
        return view('News::frontend.blocks.list-news.groupindex');
    }
 public function city(){
        return view('News::frontend.blocks.list-news.multicity');
    }
	...
	public function country(Request $request){
         $country_detail = DB::table('bravo_return_conutry')->get();
dd($country_detail);
die();
