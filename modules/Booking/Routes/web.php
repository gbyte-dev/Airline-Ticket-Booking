...
Route::group(['prefix'=>config('booking.booking_route_prefix')],function(){
    ...
    Route::post('/flightBooking','BookingController@flightBooking')->name('booking.flightBooking');
    ...
    Route::get('/{code}','BookingController@detail')->name('booking.code');
    Route::any('/{code}/checkout','BookingController@checkout')->name('booking.checkout');
	Route::any('/{code}/checkoutflight','BookingController@checkout')->name('booking.checkout.post');
    ...
    Route::get('/auto-save-form_session','BookingController@startFormSession');
    Route::post('/auto-save-form','BookingController@autoSaveForm')->name('auto.save.form');
