...
<head>
	...
	<link href="{{ asset('dist/frontend/css/jquery.dataTables.min.css') }}" rel="stylesheet">
	<link href="{{ asset('dist/frontend/trip_new/26d8b3e4474c5bd2.css') }}" rel="stylesheet">
    <link href="{{ asset('dist/frontend/trip_new/2c856af40057a805.css') }}" rel="stylesheet">
    <link href="{{ asset('dist/frontend/trip_new/30eb667f7e22f9e1.css') }}" rel="stylesheet">
    <link href="{{ asset('dist/frontend/trip_new/72277d385f45b45c.css') }}" rel="stylesheet">
