...
Route::group(['prefix'=>config('flight.flight_route_prefix')],function(){
  ...
  Route::get('/refer-and-earn','FlightController@referAndEarn')->name('flight.refer');
 
  // Search
 Route::get('/flightghtmodel','ManageFlightController@showFlightModal')->name('flight.searchmodel.flightghtmodel');
...
Route::post('/subscribe/user','SubscriptionController@index')->name('subscribe');
Route::post('/subscribe/check-ip','SubscriptionController@checkIp')->name('subscribe.check-ip');
