...

    {
        ...
        return [
            ...
            'flight'=>[
                ...
                'url'        => route('flight.admin.booking.index'),
                ...
                'children'   => [
                    ...
                    'All Booking'=>[
                     ...
                     'Leads'=>[
                        ...
                        'url'        => route('flight.admin.booking.leads'),
                    ...
                    'Top Return Flights'=>[
                        ...
                        'url'        => route('flight.admin.top-returns-deals.index'),

                        'title'      => __('Top Return Flights'),
                    ],
                    'Free Quate'=>[

                        'url'        => route('flight.admin.booking.showquote'),    

                        'title'      => __('Free Quate'),
                    ],
					 'Subscribers List'=>[

                       'url'        => route('flight.admin.subscribe.show'),
