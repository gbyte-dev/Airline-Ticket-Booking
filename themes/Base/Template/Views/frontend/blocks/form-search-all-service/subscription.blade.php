            ...
            <div class="modal-body">
                ...
                <div class="subscription-container text-center">
                    <img alt="Envelope with a voucher inside" class="email-icon" 
                        src="{{ asset('public/images/trip/aaa.png')}}"
                        width="100" />
                        ...
                        <div class="">
                            <label class="form-check-label d-flex justify-content-between" for="smsConsent">
                                ...
                                <span style="text-align: justify;">
                                    ...
                                    <a href="{{ route('page.detail',['slug' => 'privacy-policy']) }}">T&amp;Cs</a> and <a href="{{ route('page.detail', ['slug' => 'privacy-policy'])}}"
                                        >Privacy Policy</a>.
...
<script>
    $(document).ready(function() {
        ...
        $.ajax({
            url: '{{ route("subscribe.check-ip") }}', // Adjust to your route for checking IP
