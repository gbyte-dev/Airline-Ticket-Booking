            ...
            <div class="g-form-control">
                ...
                <div class="tab-content">
                        ...
                        <form action="{{ route('flight.search') }}" class="form bravo_form" method="get">
                            <div class="g-field-search">
                                <div class="row ">
                                    ...
                                    <div  onclick="swapdata(1)"> <img src="{{ url('images/swap.png') }}" onclick="swapdata(3)"
                    ...
                    <div role="tabpanel" class="tab-pane " id="bravo_space">
                        <form action="{{ route('flight.search') }}" class="form bravo_form" id="myForm"
                            method="get">
                            <div class="g-field-search">
                                <input type="hidden" name="currency" class="currencyvalue"
                                    value="{{ $curr_currency }}">
                                <div class="row ">
                                    ...
                                    {{-- <div class="webvire" style="left: 13%;position: absolute;" class="responsive-image"> <img src="{{url('images/swap.png')}}" onclick="swapdata(2)"  transfertype" ></img></div> --}}
                                    <div class="webvire responsive-image">
                                        <img src="{{ url('images/swap.png') }}" onclick="swapdata(2)"
                                    ...
                                    <div class="col-md-2 border-right">
                                        <div class="form-group">
                                            ...
                                            <div class="form-content">
                                                <div class="form-date-search is_single_picker">
                                                    {{-- new  date change code start --}}
                                                    {{-- <div class="date-wrapper">
                                                        <div class="check-in-wrapper">
                                                            <label>Depart</label>
                                                            <input type="date" name="date" class="check-in-input"  value="{{ \Carbon\Carbon::now()->format('') }}" style="border: none;">
                                            ...
                                            <div class="form-content">
                                                <div class="form-date-search is_single_picker">
                                                    ...
                                                    {{-- <div class="date-wrapper">
                                                        <div class="check-in-wrapper">
                                                            <label>Return</label>
                                                            <input type="date" name="return_date" class="check-in-out"  value="{{ \Carbon\Carbon::now()->format('Y/m/d')}}" style="border: none;">                                                           
                                                  </div>
                                                    </div>  
...
{{-- <script>
    $(document).ready(function() {
        ...
        $('input[name="date"], input[name="return_date"]').on('change', function() {
            checkDates();
        });
...
{{-- <script>
    $(document).ready(function() {
        function checkDatesR() {
            ...
            var today = "{{ \Carbon\Carbon::now()->format('m/d/Y') }}";
            if (returnDate === today) {
                return true;
            }
...
<script>
    $(document).ready(function() {
        function checkDatesR() {
            ...
            var today = "{{ \Carbon\Carbon::now()->format('YYYY-MM-DD') }}";
            var checkInDateObj = new Date(checkInDate);
            var returnDateObj = new Date(returnDate);
