    ...
    <div class="container">
        ...
        <div class="row pt-2" style="border: 2px solid  #ff7d01">
            <div class="col-md-12 col-12">
                <div class="ca">
                    @foreach ($types as $typenext)
                        <div class="row">
                            <div class="col-md-12 col-12">
                                <div class="card-header text-center ">
                                    <b class="font_manish ">
                                        {{ $typenext == 'getdata' ? 'Departure Flight Details' : 'Return Flight Details' }}</b>
                                    {{-- @if ($typenext == 'getdata')
                                        <h4 class="float-right depature_web_font" >Total Price: <span style="color: #ff7d01"><?= $icon ?>
                                            {{ number_format($totalmoney, 2) }} </span></h4>
                                    @endif --}}
                                </div>
                            </div>
                        </div>
                        @foreach ($$typenext as $datareq)
                            @if (is_array($datareq))
                                <div class="row">
                                    {{-- <div class="col-8 col-md-8">
                                        <span class="card-title"> {{ $datareq['departureLocation'] }} → <span style="color: #007bff;">{{ $datareq['durationText'] }}</span> → {{ $datareq['arrivalLocation'] }}</span>
                                    </div> --}}
                                    <div class="col-12 col-md-12">
                                        <span class="float-right font_manish ">
                                            {{ $datareq['departureDate'] }}
                                            @if (isset($datareq['way']) && $datareq['way'] == 'return')
                                ...
                                <div class="row direct-flight p-2">
                                    <div class="col-2 col-md-2">
                                        <div class="ca text-center">
                                            <img src='https://www.gstatic.com/flights/airline_logos/70px/{{ isset($datareq['airCode']) ? $datareq['airCode'] : '' }}.png'
                                                alt="American Airlines Logo" class="img-fluid" style="height: 30px">
                                            <h5 class="card-title">{{ $datareq['airName'] ?? '' }}</h5>
                                            <p class="card-text">
                                                ({{ $datareq['airCode'] }}-{{ $datareq['flightNumbers'] ?? '' }})
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-4 col-md-4">
                                        <div class="ca">
                                            <h5 class="card-title">{{ $datareq['departureLocation'] }}
                                                {{ $datareq['departureTimes'] }}</h5>
                                            <p class="card-text">{{ $datareq['departureDate'] }}</p>
                                            <p class="card-text">{{ $datareq['departureLocations'] }}</p>
                                        </div>
                                    </div>
                                    <div class="col-2 col-md-2">
                                        <div class="ca text-center" style="padding-top: 15%;">
                                            <i class="icofont-clock-time" style="font-size: 2rem; width: 1rem;"></i>
                                            <p class="card-text"> {{ $datareq['durationText'] }}</p>
                                        </div>
                                    </div>
                                    <div class="col-4 col-md-4">
                                        <div class="ca">
                                            <h5 class="card-title">{{ $datareq['arrivalTimes'] }}
                                                {{ $datareq['arrivalLocation'] }}</h5>
                                            <p class="card-text">{{ $datareq['arrivalDate'] }}</p>
                                            <p class="card-text">{{ $datareq['arrivalLocations'] }}</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- Flight Segments -->
        ...
        @if (!empty($fareRules) || !empty($fareRulesReturn))
                                ...
                                <table class="table">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                {{ $godata['iB'] > 0 ? $godata['iB'] . ' /Adult' : 'No' }}</td>
                                        </tr>
                                        <tr>
                                            <td> Cabin baggage :</td>
                                            <td class="text-right">
                                                {{ $godata['cB'] > 0 ? $godata['cB'] . ' /Adult' : 'No' }}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            <div class="card">
                                ...
                                <table class="table">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>Cancellation fee (Before {{ $hours }} hours Departure )</td>
                                            <td class="text-right">
                                                {!! $icon !!}{{ number_format($Refamount + $additionalFee + $agency, 2) }}
                                                    ...
                                                    <span class="hover-text">
                                                        <table>
                                                            <tr>
                                                                <td>Flight Cost</td>
                                                                <td class="text-right">
                                                                    {!! $icon !!}{{ number_format($totalAmount, 2) }}
                                                                <td>
                                                            </tr>
                                                            <tr>
                                                                <td>Airline Fee</td>
                                                                <td class="text-right">
                                                                    {!! $icon !!}{{ number_format($Refamount + $additionalFee, 2) }}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>Agency Fee</td>
                                                                <td class="text-right">
                                                                    {!! $icon !!}{{ number_format($agency, 2) }}
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </span>
                                        ...
                                        <tr>
                                            <td> Amount refundable(Before {{ $hours }} hours Departure)</td>
                                            <td class="text-right">
                                                @if ($totalRefund < 0)
                                                    No Refund
                                                @else
                                    ...
                                    <table class="table">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    {!! $icon !!}{{ number_format($totalDateRefund, 2) }}+Fare
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered m-0">
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <?= $icon ?>{{ number_format($flightDetails['totalBaseFare'] + $returndata['totalBaseFare'], 2) }}
                                    </td>
                                </tr>
                                <tr>
                                    <td class="text-right">Tax</td>
                                    <td class="text-right">
                                        <?= $icon ?>{{ number_format($flightDetails['totalTaxes'] + $returndata['totalTaxes'], 2) }}
                                    </td>
                                </tr>
                                <tr>
                                    <th class="text-right">Total Fare</th>
                                    <th class="text-right">
                                        <?= $icon ?>{{ number_format($flightDetails['totalFare'] + $returndata['totalFare'], 2) }}
                                    </th>
                                </tr>
                            </table>
                        </div>
...
<div class="virat" style="display: none">
    <form action="{{ route('booking.flightBooking') }}" method="post" id="form-checkout-two">

        @csrf
        <ul>

            <!-- Add Random ID Hidden Input -->
            {{-- <input type="hidden" name="departureTimes" id="departureTimes" value="{{$getdata[1]['departureTimes']?$getdata[1]['departureTimes']:''}}"> --}}
            <input type="hidden" name="from" id="departureLocation"
                value="{{ $getdata[1]['departureLocation'] ? $getdata[1]['departureLocation'] : '' }}">
            <input type="hidden" name="to" id="arrivalLocation"
                value="{{ $getdata[1]['arrivalLocation'] ? $getdata[1]['arrivalLocation'] : '' }}">
            <input type="hidden" name="on_date" id="departureDate"
                value="{{ $getdata[1]['departureDate'] ? $getdata[1]['departureDate'] : '' }}">
            <input type="hidden" name="return_date" id="returndate"
                value="{{ $returndata[1]['departureDate'] ?? '' }}">
            <input type="hidden" name="random_id" value="{{ rand(0000, 999999999999999999) }}" />
            {{-- <input type="hidden" name="flight_type" id="flight_type" value="{{$returndata[1]['departureDate']?'return':'One way'}}"> --}}
            <input type="hidden" name="currency_type" value="{{ $icon }}" />
            <input type="hidden" name="departure" value="{{ $departure }}">
            <input type="hidden" name="return" value="{{ $return }}">
            <input type="hidden" name="flight_class" value="{{ $godata['flight_class'] }}">
                                        ...
                                        @foreach ($types as $typenext)
                                            <div class="card">
                                                <div class="card-header text-center" style="color: #ff7d01">
                                                    {{ $typenext == 'getdata' ? 'Departure Flight Details' : 'Return Flight Details' }}
                                                </div>
                                            </div>
                                                ...
                                                @if (is_array($datareq))
                                                    <div class="review-section">
                                                        ...
                                                        <div class="service-info row">
                                                            ...
                                                            <div class="col-sm-3">
                                                                <img data-src="https://www.gstatic.com/flights/airline_logos/70px/{{ isset($datareq['airCode']) ? $datareq['airCode'] : '' }}.png"
                                                            ...
                                                            <div class="mt-2 col-sm-9">
                                                                ...
                                                                <div class="font-weight-medium  mb-3">
                                                                    ...
                                                                    <p class="mb-1">
                                                                        ...
                                                                        {{ $datareq['departureLocation'] }} &rarr;

                                                                        {{ $datareq['arrivalLocation'] }}

                                                                    </p>

                                                                    {{ $datareq['durationText'] }}
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="flex-self-start">
                                                                    ...
                                                                    <div class="text-lh-sm ml-1">
                                                                        ...
                                                                        <h6
                                                                            ...
                                                                            {{ $datareq['departureDate'] }}<br>
                                                                            {{ $datareq['departureTimes'] }}</h6>
                                                                        <span
                                                                            class="font-size-14 font-weight-normal text-gray-1">{{ $datareq['departureLocations'] }}</span>
                                                                ...
                                                                <div class="flex-self-start">
                                                                    ...
                                                                    <div class="text-lh-sm ml-1">
                                                                        ...
                                                                        <h6
                                                                            class="font-weight-bold font-size-21 text-gray-5 mb-0">
                                                                            {{ $datareq['arrivalDate'] }}<br>
                                                                            {{ $datareq['arrivalTimes'] }}</h6> <span
                                                                            class="font-size-14 font-weight-normal text-gray-1">{{ $datareq['arrivalLocations'] }}</span>
                                                    ...
                                                    {{-- <div class="review-section">
                                                        ...
                                                        <ul class="review-list">
                                                            ...
                                                            <li>
                                                                ...
                                                                <div class="val"> {{ $datareq['durationText'] }}
                                                                </div>
                                            ...
                                            <ul class="review-list">
                                                ...
                                                <li class="final-total d-block">
                                                    <div class="d-flex justify-content-between">
                                                        ...
                                                        <div class="val">
                                                            <span class="font_manish">
                                                                <?= $icon ?>{{ number_format($flightDetails['totalDiscount'] + $returndata['totalDiscount'], 2) }}
                                                            </span>
                                                        </div>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="final-total d-block">
                                                    <div class="d-flex justify-content-between">
                                                        ...
                                                        <div class="val">
                                                            ...
                                                            <div class="val">
                                                                <span
                                                                    class="font_manish"><?= $icon ?>{{ number_format($total, 2) }}
                                                                </span>
                                                            </div>
