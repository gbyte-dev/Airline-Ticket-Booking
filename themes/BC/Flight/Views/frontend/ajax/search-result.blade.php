<script>
    ...
    var sessionCurrency = @json(session('currency', 'CAD')); 
...
?>
@include('Flight.Views.frontend.ajax.onward')
<?php     
        ...
        $a = 1;
        ?>
@include('Flight.Views.frontend.ajax.return')
<?php 
...
<!-- <form  id="flightalldetails" action="{{ route('booking.checkout', ['code' => $msg]) }}" method="post"> -->
<form id="flightalldetails" action="{{ route('booking.checkout.post', ['code' => $msg]) }}" method="post" onsubmit="return checkvalues()">
    @csrf
