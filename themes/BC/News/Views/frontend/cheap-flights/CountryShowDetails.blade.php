        ...
        <div class="row">
            ...
            @endphp 
             ...
             <div class="col-md-6 col-lg-4 pt-4">
                <div class="main-heading">
                    ...
                    Cheap Flights to {{ $country_detail->country_name }}
                    </h5><br><br>
                </div>
                <div class="deal-box">
            ...
            <div class="bravo-list-news">
                ...
                <div class="container custom-container">
                    ...
                    <h4>Lowest All-in Round-trip Airfares to<b> {{$country_detail->country_name}}</b></h4>
                    {{-- @if ($country_detail)  --}}
                    {{-- @foreach ($country_detail as $user) --}}

                    <div class="d-lg-flex d-block col-12  " style="padding-top:0px;">
                        {{-- <div class="image-section col-12 col-lg-4 col-md-12">
                       <img src="{{ url('uploads/country_images/' . $user->country_image) }}" alt="Africa Image">               
                        ...
                        <div class="container">
                            ...
                            {{-- <h2>{{ $user->country_name }}</h2> --}}

                            {{-- <h5 class="currencyvalue">{{ str_replace(' ','',$user->from_price) }}</h5> --}}
                            @php
                                //   $countryId = $user->id;
                            ...
                            <div class="deals-grid">
                                @foreach ($cities as $city)
                                    <a href="{{ route('cheap-flights', str_replace(' ', '-', $city->city)) }}"
                                        class="deal-link">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <input class="form-control departureDateR" placeholder="Departure Date"
                                                    ...
                                                    value="{{ \Carbon\Carbon::now()->format('Y-m-d') }}" min="{{ \Carbon\Carbon::now()->format('Y-m-d') }}" />
                                            ...
                                            <div class="col-md-6">
                                                <input class="form-control returnDateR" placeholder="Return Date" name="enddate"
                                                    required="" type="date" value="{{ \Carbon\Carbon::now()->format('Y-m-d') }}" min="{{ \Carbon\Carbon::now()->format('Y-m-d') }}" />
                                        ...
                                        <div class="row">
                                            {{-- <div class="col-md-12">
                                                ...
                                                <input  class="form-control" placeholder="Phone*" required=""
                                                    name="phone" type="tel" id="mobile_code" autocomplete="off"/>
                                            </div> --}}
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', async () => {
        await fetchExchangeRates(); // Ensure latest exchange rates are available 2
