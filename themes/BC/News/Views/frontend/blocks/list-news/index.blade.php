...
.deal-card {
  background-image: url("{{ asset('images/today/delhi2.jpg') }}");
...
.deal-card1 {
  background-image: url("{{ asset('images/today/mumbai2.jpg') }}");
  background-size: cover;
  background-position: center;
  height: 245px;
  position: relative;
...
.deal-card2 {
  background-image: url("{{ asset('images/today/bangalore2.jpeg') }}");
  background-size: cover;
  background-position: center;
  height: 245px;
  position: relative;
...
.deal-card3 {
  background-image: url("{{ asset('images/today/hyderabad.jpg') }}");
  background-size: cover;
  background-position: center;
  height: 245px;
  position: relative;
...
.deal-card4 {
  background-image:url("{{ asset('images/today/ahmedabad.jpg') }}");
  background-size: cover;
  background-position: center;
  height: 245px;
  position: relative;
...
.deal-card2 {
  background-image: url("{{ asset('images/today/Bangalore.jpg') }}");
  background-size: cover;
  background-position: center;
  height: 245px;
  position: relative;
...
.deal-card3 {
  background-image: url("{{ asset('images/today/Hyderabad.webp') }}");
  background-size: cover;
  background-position: center;
  height: 245px;
  position: relative;
...
.deal-card4 {
  background-image:url("{{ asset('images/today/ahmedabad0.jpg') }}");
  background-size: cover;
  background-position: center;
  height: 245px;
  position: relative;
    ...
    <div class="row">
          ...
          <div class="deal-card">
            <div class="deal-content">
              ...
              <div class="deal-info">
                ...
                <a href="{{ route('CountryShowDeals') }}" class="btn btn-primary btn-sm" id="btn-primary">View</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="col-lg-3 col-md-12">
        <div class="contact-section">
          <img src="{{asset('images/today/dp.png')}}" class="rounded-circle mb-3" alt="Agent">
                        ...
                        <div class="deals-grid">
                            @foreach ($city_detail as $city)
                                <a href="{{ route('cheap-flight', str_replace(' ', '-', $city->city)) }}"
                                    class="deal-link">
                                    <div class="deal-item" >{{ $city->city }} 
                                    <span class='currencyvalue' >{{ str_replace(' ', '', $city->discount_price) }}></span></div>
                                </a>
                            @endforeach
                        </div>
                        <a href="{{ route('showallCountry', ['city'=> $user->country_name]) }}" class="view-deals-button">
                    View all {{ $user->country_name }} Deals
                    </a> 
                        {{-- <a href="{{ route('showallcountry', $user->id) }}" class="view-deals-button">
                            View all {{ $user->country_name }} Deals
                        </a> --}}
