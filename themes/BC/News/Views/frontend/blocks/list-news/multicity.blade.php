...
<!-- Swiper CSS -->
 <!-- <link rel="stylesheet" href="https://unpkg.com/swiper/swiper-bundle.min.css" /> -->
   <style>
.airplane-badge {
    background: url("{{asset('images/multi/airplane.png')}}") no-repeat;
    width: 24px;
    height: 20px;
        margin-top: 4px;
}
.location-badge {
    background: url("{{asset('images/multi/location.png')}}") no-repeat;
    width: 20px;
    height: 20px;
        margin-top: 4px;
}
.wallet-badge {
    background: url("{{asset('images/multi/wallet.png')}}") no-repeat;
    width: 20px;
    height: 20px;
        margin-top: 4px;
}
...
.custom-select {
  ...
  <style>
    ...
    #content {
    /* background:url("{{ asset('images/group/multi.jpg') }}") no-repeat center center/cover; */
	 background:url("{{ asset('images/multi/mainbanner2.jpg') }}")no-repeat ; 
      display: flex;
         height: 735px;
      max-width: 1425px;
	  	  background-size:cover;
    ...
    #content1 {
   /* background:url("{{ asset('images/multi/ci.webp') }}") right center / contain no-repeat; */
    background:url("{{ asset('images/multi/ci1.jpg') }}") right center / contain no-repeat;
        margin-right: 90px;
    width: 536px;
    height: 481px;
    }
...
.top-block-image_0 {
       width: 80px;
    height: 80px;
    background: url("{{asset('images/multi/why-book-icon_0.png')}}") 0% 0% / contain;
}
.top-block-image_1 {
       width: 80px;
    height: 80px;

    background: url("{{asset('images/multi/why-book-icon_1.png')}}") 0% 0% / contain;
}
.top-block-image_2 {
       width: 80px;
    height: 80px;
    background: url("{{asset('images/multi/why-book-icon_2.png')}}") 0% 0% / contain;
}
.top-block-image_3{
       width: 80px;
    height: 80px;
    background: url("{{asset('images/multi/why-book-icon_3.png')}}") 0% 0% / contain;
}
.tw-m-auto {
    margin: auto;
}
...
<?php } ?>
  <div class="container content" id="content" >
    ...
    <!-- Left section -->
    <div class="d-none d-lg-block d-md-block  col-lg-6 col-md-4 info ">
        <div class="con_text">
      <h1 style="color: rgb(255, 255, 255);font-size: 32px; font-weight: 400;">Multi-City Flights</h1>
      <p style="color: rgb(255, 255, 255); ">Nothing can substitute the resources and skills of our Travel
Professionals when you plan complex flight. No matter what you call it: Around-the-World, Round-the-World, Multi-Stop, Multi Destination or Multi-City travel, only live travel experts can tailor routes of any complexity and get the best price for your airfare.</p>
      <h3 style="color: rgb(255, 255, 255);">Around the world and multi-stop flights</h3>
    </div>
<div class="wrap-10-0 tw-flex tw-justify-between">
    <div class="badge-container tw-flex max-tablet:tw-flex-col">
        <div class="airplane-badge"></div><p class="wrap-0-10">Any Airline</p></div>
        <div class="badge-container wrap-0-30 tw-flex max-tablet:tw-flex-col"><div class="location-badge"></div>
        <p class="wrap-0-10">Any Route</p></div>
        <div class="badge-container tw-flex max-tablet:tw-flex-col"><div class="wallet-badge">
        </div><p class="wrap-0-10">Any Budget</p></div></div>
</div>
    ...
    @keyframes spin {
      ...
      100% { transform: rotate(360deg); }
                                                        ...
                                                        <div class="row mb-2">
														<span class="span-icon" style="position: absolute;left: -.7rem;top:29%">1</span>
                                                           ...
                                                           <i class="span-icon fa fa-times remove-row" style="position: absolute;right: -18px;top: 29%;"></i>
                                                        </div>
														
														
														<div class="row">
														<span class="span-icon" style="position: absolute;left: -.7rem;top:38%">2</span>
                                                            <div class="col smart-search">
                                                                <input type="text"
                                                                    class="smart-search-location parent_text form-control font-size-14"
                                                                    placeholder="From*" value="{{ $fromwhere }}"
                                                           ...
                                                           <i class="span-icon fa fa-times remove-row" style="position: absolute;right: -18px;top: 38%;"></i>
                                                        </div>
														<script>
...
$(document).ready(function() {
 ...
 <section class="why-book-section" style="color:black; font-family: sans-serif;    color: rgb(112, 112, 112);">
   <section class="sc-f64aa1ab-1 ldbciA header-container"><h2 class="main-title wrap-40-0 f-size-30 tw-text-center tw-font-normal">Why Book Multi-city Flights?</h2>
    <div class="wrap-35-0 mobile-scrollbar tw-flex tw-justify-between">
        <div class="slider-wrap tw-mx-auto tw-my-0"><div class="top-block-image_0 tw-m-auto"></div><p class="tw-text-center tw-text-[12px] desktop:tw-text-[14px]">One <b>multi-city flight is cheaper</b> than multiple one-way tickets</p></div>
        <div class="slider-wrap tw-mx-auto tw-my-0">
            <div class="top-block-image_1 tw-m-auto"></div>
            <p class="tw-text-center tw-text-[12px] desktop:tw-text-[14px]">It’s an <b>easy and cheap</b> way to travel around the world</p></div>
            <div class="slider-wrap tw-mx-auto tw-my-0"><div class="top-block-image_2 tw-m-auto"></div><p class="tw-text-center tw-text-[12px] desktop:tw-text-[14px]"><b>Simply</b> because you LOVE traveling</p></div>
            <div class="slider-wrap tw-mx-auto tw-my-0"><div class="top-block-image_3 tw-m-auto"></div><p class="tw-text-center tw-text-[12px] desktop:tw-text-[14px]">You can explore as <b>many destinations</b> as you want</p></div></div>
</section>
</section>
...
<!-- new section -->
  ...
  <section class="why-book-section1"  style="font-family: sans-serif;    color: rgb(112, 112, 112);background-color: rgb(243 239 239);" >
    <div class="container">
        <h2 class="main-title wrap-40-0 f-size-30 tw-text-center tw-font-normal">Why Trust Multi-city Flight Booking to Us?</h2>
      <div class="row">
      ...
      <div class="col-lg-6 ">
        <div class="row" id="content1" style="font-family: sans-serif;  ">
         ...
         <div class="col-lg-6 " style="color: black;">
           <div class="why-book-features wrap-20-30 sm-wrap-30-20 tw-m-auto"><ul class="f-size-12 sm-f-size-14" style="color:#3b3536;"><div class="wrap-10-0 tw-flex"><div class="slash"></div><li>
It’s not an easy DIY job</li></div><div class="wrap-10-0 tw-flex" ><div class="slash"></div><li>
We have 20+ years of experience with multi-city flights</li></div><div class="wrap-10-0 tw-flex"><div class="slash"></div><li>
Our agents know where to find the cheapest tickets</li></div><div class="wrap-10-0 tw-flex"><div class="slash"></div><li>
We can hold a seat in case you need time to decide</li></div><div class="wrap-10-0 tw-flex"><div class="slash"></div><li>Over 2,400 agents are available before, during and after your trip</li></div><div class="wrap-10-0 tw-flex"><div class="slash"></div><li>We offer multi-city flights to more than 200 destinations</li></div><div class="wrap-10-0 tw-flex"><div class="slash"></div><li>You get a free hotel room for overnight stays</li></div>
<div class="wrap-10-0 tw-flex"><div class="slash"></div><li>You get a free hotel room for overnight stays</li></div>
</ul></div>
         </div>
      </div>
    </div>
...
<section class="why-book-section"   style="font-family: sans-serif;    color: rgb(112, 112, 112);">
   <div class="container">
      ...
      <div class="text-block" ><h2 class="wrap-30-0 f-size-20 tw-font-normal" style="text-align: left;">About Multi-City Travel</h2><p class="tw-text-[12px] tw-leading-[1.6] desktop:tw-text-[14px]" style="color:#3b3536;">Tripgare is an airline ticket consolidator and a travel agency at the same time. We provide our clients with reduced airfares negotiated at wholesale pricing and a personalized response to each and every request! We are dedicated to providing our customers with only the finest and most affordable flights. We have worked with over 500 major airlines to provide our clients with a variety of travel alternatives.</p></div>
      </div>
         <div class="col-lg-6 ">
      <!--    <div class="tw-h-[200px] tw-w-auto tw-bg-center tw-bg-no-repeat max-tablet:tw-bg-cover tablet:tw-h-[560px] tablet:tw-w-[534px]" style="background-size: contain; background-image:url(&quot;{{ asset('images/multi/c1.webp') }}&quot;)" ></div> -->
          <div class="tw-h-[200px] tw-w-auto tw-bg-center tw-bg-no-repeat max-tablet:tw-bg-cover tablet:tw-h-[560px] tablet:tw-w-[534px]" style="background-size: contain; background-image:url(&quot;{{ asset('images/multi/c123.jpg') }}&quot;)" ></div>
         </div>
      </div>
    </div>
</section>
...
<section class="why-book-section" id="slidersec"   style="font-family: sans-serif;    color: rgb(112, 112, 112);">
     <div class="container564" style="padding-top:40px;">
	<!-- reviews show part -->
    ...
    <div class="modal-content2 position-relative">
        ...
        <div class="row g-0">
            ...
            <div class="modal-text col-md-6 d-flex flex-column justify-content-center p-4">
                <h3 class="review-text" style="font-size:15px">How it Works?</h3>
...
{{-- popup --}}
  ...
  <script>
    ...
    $(document).ready(function() {
        ...
        $.ajax({
            url: '{{ route("news.group") }}', // Adjust to your route for checking IP
