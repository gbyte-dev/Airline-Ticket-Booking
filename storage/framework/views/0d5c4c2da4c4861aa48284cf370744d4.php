...
<?php $__env->startSection('content'); ?>
    <div class="container">
        <div class="row">
            ...
            ?> 
             ...
             <div class="col-md-6 col-lg-4 pt-4">
                <div class="main-heading">
                    ...
                    Cheap Flights to <?php echo e($country_detail->country_name); ?>
                ...
                <div class="deal-box">
                    <div class="box_vijay" style="">
                        <b style="color:#ff7d01;">
                                        ...
                                        <p style="
                                        font-size: 14px;
                                    "><b>Limited-time </b>Offer! Ends <?php echo e(\Carbon\Carbon::now()->addDays(2)->format('d M')); ?></p>
                    </div>
                    ...
                    <div class="price" onclick="document.getElementById('id01').style.display='block'">
                        <span class="currencyvalue">
                            ...
                            <?php echo e(str_replace(' ', '', $country_detail->from_price)); ?>
                    ...
                    <p>
                        1 in 4 people who visit <?php echo e($city); ?> book with TRIPGARE Tickets
                    </p> 
                    <p>
                        ...
                        <div role="tabpanel" class="tab-pane  <?php echo e($oneway); ?>  " id="bravo_hotel">
                            <form action="<?php echo e(route('freequote')); ?>" class="form bravo_form d-block" method="post"
                                ...
                                <div class="container mb-2">
                                    ...
                                    <input type="hidden" name="booking_type" id="bookingTypeInput" value="round-trip"
                                        required>
                                </div>
                                <div class="form-group">
                                    <div class="row ">
                                        ...
                                        <div class="col smart-search">
                                            <input type="text"
                                                class="smart-search-location parent_text form-control font-size-14"
                                                placeholder="To*" value="<?php echo e($to_where); ?>" data-onload="Loading..."
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col  pt-2 pb-2">
                                            <input class="form-control departureDate" name="start_date" type="date"
            ...
            <div class="bravo-list-news">
                ...
                <div class="container custom-container">
                    ...
                    <h4>Lowest All-in Round-trip Airfares to<b> <?php echo e($country_detail->country_name); ?></b></h4>
                        ...
                        <div class="container">
                            ...
                            <div class="deals-grid">
                                <?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <a href="<?php echo e(route('cheap-flights', str_replace(' ', '-', $city->city))); ?>"
                                        class="deal-link">
        ...
        <div class="container review-section">
            <h2>97% Of canada Travelers Recommend TRIPGARE Tickets</h2>
            <div class="stars">
        ...
        <div class="container">
            <div class="content-section">
                <h3>
                    Flight Tickets to canada, Nigeria
                </h3>
                <p>
                    Finding cheap flights tocanadaonline can be quite challenging. TRIPGARE Tickets can do
                    all
                    the footwork for you
                    to save time and money. Our Travel Agents manually put together the best-priced airfares to the
                    canadawith
                    the most convenient itineraries to offer you cheap tickets to canada. Fly to
                    canadawith our special
                    negotiated online and offline airfares unavailable online and save on your flight to
                    canada. Our contracted
                    airline rates give you access to the best flight deals among hundreds of different airlines. The times
                    when
                    the travel was cheap are back! For affordable travel to canada, call to speak to a travel
                    agent or submit a
            ...
            <div class="row content-section">
                <div class="col-md-6">
                    ...
                    <p>
                        ...
                        tickets
                        to
                        canadafor a limited time only. Contact our agents to learn more about all our
                ...
                <div class="col-md-6">
                    ...
                    <p>
                        ...
                        tickets tocanadaand other destinations. Through over a decade of industry
                        ...
                        deals
                        to
                        canada. Feel free to browse through our website and stay connected through our
                        newsletter and social
                        media accounts to be the first to know about the best availablecanadaflight deals.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div id="id01" class="w3-modal" style="z-index:99 !important;">
            <div class="w3-modal-content" style="width:750px;">
                <div class="w3-container" style="padding: 0px;">
                    <span onclick="document.getElementById('id01').style.display='none'" class="float-end "
                        style=";
                        active:hover{
                            background-color: yellow;
                            padding:0px;
                    ...
                    <div class="virat-container" style="font-size: 14px;">
                        <div class="row">
                            <div class="d-none d-md-block col-md-5  pt-1"
                                style="font-size: 14px;background-color:    #f7f6f6;">
...
color:white; 
                                    ...
                                    <form action="<?php echo e(route('freequote')); ?>" class="form bravo_form d-block"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <input class="form-control departureDateR" placeholder="Departure Date"
                                                    name="start_date" required="" type="date"
                                                    value="<?php echo e(\Carbon\Carbon::now()->format('Y-m-d')); ?>" min="<?php echo e(\Carbon\Carbon::now()->format('Y-m-d')); ?>" />
                                                    <div class="invalid-feedback departureDateErrorR" style="width:100%; text-align:left;"> </div>
                                            </div>
                                            <div class="col-md-6">
                                                <input class="form-control returnDateR" placeholder="Return Date" name="enddate"
                                                    required="" type="date" value="<?php echo e(\Carbon\Carbon::now()->format('Y-m-d')); ?>" min="<?php echo e(\Carbon\Carbon::now()->format('Y-m-d')); ?>" />
                            ...
                            <div class="d-block d-sm-none col-md-5 pt-1"
                                style="font-size: 14px;background-color:  #f9f9f9;">
                                <p class="virat-header-text">
                                    Want it lower than
                                    <span class="virat-highlight">
...
<script>
    ...
    function updateTotalPrice_change(pr) {

        var conversionRates = {
            'USD': 0.74, // 1 CAD = 0.74 USD
            'CAD': 1, // 1 CAD = 1 CAD (base currency)
            'INR': 61.42 // 1 CAD = 61.42 INR
        };
        ...
        el.forEach(function(el) {
            var totalPrice = 0;
            var totalprice = 0;
            totalprice = parseFloat(el.innerHTML.replace(/[^\d.-]/g, ''));
            totalPrice = totalprice * conversionRates[pr];
            el.innerHTML = getCurrencyIcon_change(pr) + '' +
                `${totalPrice.toLocaleString()}`;; // Append 'pqr' to the current content
        });
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/tripgwdd/flight.tripgare.com/themes/BC/News/Views/frontend/cheap-flights/CountryShowDetails.blade.php ENDPATH**/ ?>