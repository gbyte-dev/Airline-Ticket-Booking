		...
		<div class="tw-shrink-0 tw-grow tw-basis-auto">
			...
			<div class="tw-relative tw-min-h-[460px]">
				...
				<div class="block-wrapper tw-relative !tw-mt-0 tw-flex tw-flex-col tw-justify-between !tw-pt-0 klckwT">
					...
					<div class="tw-flex">
						<div class="tw-w-full">
							<h1 class="sc-156dc327-0 jDJjAw bold tw-text-center">Cheap Flights to <?php echo e($country_detail->country_name); ?></h1>
											...
											<div class="pos-rltg">
												...
												<div class="tw-relative tw-mb-8 tw-mt-48">
													<div class="tw-px-20">
														...
														<span class="currencyvalue" id="vj_price2" data-qa-quote-form="special-fare"> <?php if(isset($country_detail)): ?>
																	<?php echo e(str_replace(' ', '', $country_detail->from_price)); ?>
			...
			<section class="block-wrapper m-t-lg">
				<div>
					<div class="tw-mb-32 desktop:tw-mb-16">
						<h2 class="tw-mb-[15px] tw-text-center tw-text-[20px] tw-leading-[21px] desktop:tw-text-left desktop:tw-leading-[31px]">Flight Tickets to <?php echo e($country_detail->country_name); ?>, Nigeria</h2>
					...
					<div class="tw-block tablet:tw-flex desktop:-tw-mx-24">
						<div class="tw-w-full tablet:tw-w-1/2 desktop:tw-px-24">
							<div class="tw-mb-32 desktop:tw-mb-16">
								<h2 class="tw-mb-[15px] tw-text-center tw-text-[20px] tw-leading-[21px] desktop:tw-text-left desktop:tw-leading-[31px]">Find Cheap Flights to <?php echo e($country_detail->country_name); ?></h2>
						...
						<div class="tw-w-full tablet:tw-w-1/2 desktop:tw-px-24">
							<div class="tw-mb-32 desktop:tw-mb-16">
								<h2 class="tw-mb-[15px] tw-text-center tw-text-[20px] tw-leading-[21px] desktop:tw-text-left desktop:tw-leading-[31px]">About <?php echo e($country_detail->country_name); ?> Travel</h2>
				...
				<div class="bravo-list-news">
					...
					<div class="container custom-container" style="padding: 0;margin:0; ">
						...
						<h4 id="c768">Lowest All-in Round-trip Airfares to<b> <?php echo e($country_detail->country_name); ?></b></h4>
								...
								<div class="b-b-grey tw-relative">
								   <span class="text-lg bold">
									  <div class="tw-relative">
										...
										<span class="currencyvalue" style="font-size:19px;"> <?php if(isset($country_detail)): ?>
											<?php echo e(str_replace(' ', '', $country_detail->from_price)); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/tripgwdd/flight.tripgare.com/themes/BC/News/Views/frontend/cheap-flights/CountryShow_new.blade.php ENDPATH**/ ?>