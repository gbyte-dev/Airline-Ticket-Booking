...
.custom-select {
  ...
  <style>
    ...
    #content {
    background:url("<?php echo e(asset('images/group/newbacknew2.jpg')); ?>") no-repeat center center/cover;
      display: flex;
/*      align-items: center;*/
      height:627px;
      max-width: 1366px;
  ...
  /*  #content1 {
		background:url("<?php echo e(asset('images/group/group8.jpeg')); ?>") right center / contain no-repeat;
		  height: 100%;
    }
	*/
	 
	    #content1 {
		 background:url("<?php echo e(asset('images/group/childfather.jpg')); ?>") right center / contain no-repeat;
		  height: 100%;
    }
...
Book your wedding group trips with our expert travel agents. Call Tripgaretoday!</p></div> 
         ...
         <div class="col-lg-6 ">
       <!--   <div class="tw-h-[200px] tw-w-auto tw-bg-center tw-bg-no-repeat max-tablet:tw-bg-cover tablet:tw-h-[560px] tablet:tw-w-[534px]" style="background-image:url(&quot;<?php echo e(asset('images/group/group4.jpeg')); ?>&quot;)"></div> -->
          <div class="tw-h-[200px] tw-w-auto tw-bg-center tw-bg-no-repeat max-tablet:tw-bg-cover tablet:tw-h-[560px] tablet:tw-w-[534px]" style="background-image:url(&quot;<?php echo e(asset('images/group/sellernew1.jpg')); ?>&quot;)"></div>
         </div>
      </div> 
    </div>
</section>
...
<section class="why-book-section2"">
   <div class="container">
      ...
      <div class="row" id="rowid" >
        <div class="col-lg-6 ">
     <!--     <div class="tw-h-[200px] tw-w-auto tw-bg-center tw-bg-no-repeat max-tablet:tw-bg-cover tablet:tw-h-[560px] tablet:tw-w-[534px]" id="business-travel" style="background-image:url(&quot;<?php echo e(asset('images/group/group3.jpeg')); ?>&quot;)"> </div> -->
          <div class="tw-h-[200px] tw-w-auto tw-bg-center tw-bg-no-repeat max-tablet:tw-bg-cover tablet:tw-h-[560px] tablet:tw-w-[534px]" id="business-travel" style="background-image:url(&quot;<?php echo e(asset('images/group/grouptravel4.jpg')); ?>&quot;)"> </div>
         </div>
      <div class="col-lg-6 ">
...
We can also help you <a href="#">organize a Hajj or Umrah trip</a> or a pilgrimage group trip.</p><h3 class="f-size-14 sm-f-size-16 wrap-15-0 bold"><a href="#">School Trips</a></h3><p class="f-size-12 sm-f-size-14">Planning an educational trip or a volunteer mission for your school? Tripgare is here to <a href="#">organize your school's trip seamlessly</a>. Take advantage of our discounted flights and exclusive group rebates tailored for teacher and student trips. Let us make your educational or voluntourism journey a reality with affordable and convenient travel solutions.</p></div>
        ...
        <div class="col-lg-6 ">
       <!--   <div class="tw-h-[200px] tw-w-auto tw-bg-center tw-bg-no-repeat max-tablet:tw-bg-cover tablet:tw-h-[560px] tablet:tw-w-[534px]"  style="background-image:url(&quot;<?php echo e(asset('images/group/group1.jpeg')); ?>&quot;)"></div>   -->
          <div class="tw-h-[200px] tw-w-auto tw-bg-center tw-bg-no-repeat max-tablet:tw-bg-cover tablet:tw-h-[560px] tablet:tw-w-[534px]"  style="background-repeat: round; background-image:url(&quot;<?php echo e(asset('images/group/flightgroup1.jpg')); ?>&quot;)"></div> 
         </div>
      </div>
    </div>
</section>
      ...
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
          <div class="row " style="font-family: sans-serif; color: rgb(67 66 66);">
            ...
            <!--  <img src="<?php echo e(asset('images/group/group2.webp')); ?>" alt="Destination Image 2">  -->
              <img src="<?php echo e(asset('images/group/group2.jpg')); ?>" alt="Destination Image 2">
            </div>
          </div>
        </div>
        <!-- Slide 2 -->
        <div class="swiper-slide">
          <div class="row" style="font-family: sans-serif; color: rgb(67 66 66);">
            ...
            <div class="col-lg-4 image-container">
              <img src="<?php echo e(asset('images/group/group5.jpg')); ?>" alt="Destination Image 2">
            </div>
          </div>
        </div>
        <!-- Slide 3 -->
        <div class="swiper-slide">
          <div class="row  "  style="font-family: sans-serif; color: rgb(67 66 66);">
            ...
            <div class="col-lg-6 image-container">
              <img src="<?php echo e(asset('images/trip_new/telecaller.webp')); ?>" alt="Destination Image 3">
            </div>
          </div>
        </div>
      </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/tripgwdd/flight.tripgare.com/themes/BC/News/Views/frontend/blocks/list-news/groupindex.blade.php ENDPATH**/ ?>