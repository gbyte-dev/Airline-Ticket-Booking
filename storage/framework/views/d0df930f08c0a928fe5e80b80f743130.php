            ...
            <div class="g-form-control">
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li role="bravo_hotel" onclick="changedisable('departureform','returnform')">
                        <a href="#bravo_hotel" class="<?php echo e($oneway); ?> text-white" aria-controls="bravo_hotel"
                    ...
                    <li role="bravo_space" onclick="changedisable('returnform','departureform')">
                        <a href="#bravo_space" class="	<?php echo e($return); ?> text-white" aria-controls="bravo_space"
                            role="tab" data-toggle="tab">
                        ...
                        <form action="<?php echo e(route('flight.search')); ?>" class="form bravo_form" method="get"
                                            ...
                                            <div class="form-content">
                                                ...
                                                <div class="smart-search">
                                                    <input type="text"
                                                        ...
                                                        placeholder="City or airport" value="<?php echo e($fromwhere); ?>"
                                                        data-onload="Loading..." data-default="" id="fromwhere1"
                                                        required autocomplete="off">
                                                    <input type="hidden" id="from1" class="child_id"
                                                        name="from_where" value="<?php echo e($fromwhere); ?>" required >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="webvire2" >
                                         <img src="<?php echo e(url('images/swap.png')); ?>" 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-content">
                                                ...
                                                <div class="smart-search">
                                                    <input type="text"
                                                        class="smart-search-location parent_text form-control font-size-14"
                                                        placeholder="City or airport" value="<?php echo e($to_where); ?>"
                                                        data-onload="Loading..." data-default="" id="wherewhere1"
                                                        required autocomplete="off">
                                                    <input type="hidden" id="where1" class="child_id"
                                                        name="to_where" value="<?php echo e($to_where); ?>" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="date-wrapper">
                                                        <div class="check-in-wrapper">
                                                            ...
                                                            <div class="render check-in-render">
                                                                <?php echo e($departure_date); ?></div>
                                                        </div>
                                                    </div>

                                                    <input type="text" class="check-in-out" name="date"
                                                        value="<?php echo e($departure_date); ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-content">
                                                ...
                                                <div class="smart-search">
                                                    <select id="seatingClassDropdown" class="form-control font-size-14"
                                                        ...
                                                        <option value="any"
                                                            <?php echo e($seatingtype == 'any' ? 'selected' : ''); ?>>ANY</option>
                                                        <option value="economy"
                                                            <?php echo e($seatingtype == 'economy' ? 'selected' : ''); ?>>ECONOMY
                                                        </option>
                                                        <option value="premium_economy"
                                                            <?php echo e($seatingtype == 'premium_economy' ? 'selected' : ''); ?>>
                                                            PREMIUM ECONOMY</option>
                                                        <option value="business"
                                                            <?php echo e($seatingtype == 'business' ? 'selected' : ''); ?>>BUSINESS
                                                        </option>
                                                        <option value="first"
                                                            <?php echo e($seatingtype == 'first' ? 'selected' : ''); ?>>FIRST
                                                        </option>
                                                    </select>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="dropdown-item-row">
                                                        ...
                                                        <div class="val">
                                                            ...
                                                            <span class="count-display"><input id="seat_type_vip_6"
                                                                    ...
                                                                    value="<?php echo e($adultcount); ?>" min="0"
                                                                    required></span>
                            ...
                            <div class="g-button-submit">
                                <button class="btn btn-danger btn-search" type="submit"
                                    <?php echo e($onewaydisable); ?>>Search</button>
                            </div>
                        </form>
                    </div>

                    <div role="tabpanel" class="tab-pane <?php echo e($return); ?>" id="bravo_space">
                        <form action="<?php echo e(route('flight.search')); ?>" class="form bravo_form myFormSpace" method="get"
                            id="returnform"  >
                            <div class="g-field-search">
                                <div class="row ">
                                    <div class="col-md-2 border-right">
                                            ...
                                            <div class="form-content">
                                                ...
                                                <div class="smart-search">
                                                    ...
                                                    <input type="hidden" class="child_id" name="from_where"
                                                        id="from2" value="<?php echo e($fromwhere); ?>" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <input type="hidden" name="currency" class="currencyvalue"
                                        value="<?php echo e($curr_currency); ?>">
                                    <div class="responsive-image webvire" > <img src="<?php echo e(url('images/swap.png')); ?>"
                                            ...
                                            <div class="form-content">
                                                ...
                                                <div class="smart-search">
                                                    ...
                                                    <input type="hidden" class="child_id" name="to_where"
                                                        id="where2" value="<?php echo e($to_where); ?>" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="date-wrapper">
                                                        <div class="check-in-wrapper">
                                                            ...
                                                            <div class="render check-in-render"  id="return-date">
                                                                <?php echo e($returndate); ?></div>
                                                        </div>
                                                    </div>
                                                    <input type="hidden" class="check-in-input"
                                                        value="  <?php echo e($returndate); ?>" name="return_date">
                                                    <input type="text" class="check-in-out" name="return_date"
                                                        value="  <?php echo e($returndate); ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<!-- <script>
    $(document).ready(function() {
        function checkDatesR() {
            ...
            var today = "<?php echo e($returndate); ?>";
            if (returnDate === today) {
                return true;
            }
...
<?php /**PATH /home4/tripgwdd/flight.tripgare.com/themes/BC/Flight/Views/frontend/layouts/search/form-search.blade.php ENDPATH**/ ?>