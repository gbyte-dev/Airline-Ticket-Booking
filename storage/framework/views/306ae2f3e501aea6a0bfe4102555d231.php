...
.custom-select {
  ...
  <style>
    ...
    #content1 {
   /* background:url("<?php echo e(asset('images/multi/ci.webp')); ?>") right center / contain no-repeat; */
...
<section class="why-book-section"   style="font-family: sans-serif;    color: rgb(112, 112, 112);">
   <div class="container">
      ...
      <!--    <div class="tw-h-[200px] tw-w-auto tw-bg-center tw-bg-no-repeat max-tablet:tw-bg-cover tablet:tw-h-[560px] tablet:tw-w-[534px]" style="background-size: contain; background-image:url(&quot;<?php echo e(asset('images/multi/c1.webp')); ?>&quot;)" ></div> -->
          <div class="tw-h-[200px] tw-w-auto tw-bg-center tw-bg-no-repeat max-tablet:tw-bg-cover tablet:tw-h-[560px] tablet:tw-w-[534px]" style="background-size: contain; background-image:url(&quot;<?php echo e(asset('images/multi/c123.jpg')); ?>&quot;)" ></div>
         </div>
      </div>
    </div>
</section>
...
<section class="why-book-section" id="slidersec"   style="font-family: sans-serif;    color: rgb(112, 112, 112);">
	...
	<!-- reviews show part -->
 <?php echo $__env->make('News::frontend.blocks.staticreviews', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/tripgwdd/flight.tripgare.com/themes/BC/News/Views/frontend/blocks/list-news/multicity.blade.php ENDPATH**/ ?>