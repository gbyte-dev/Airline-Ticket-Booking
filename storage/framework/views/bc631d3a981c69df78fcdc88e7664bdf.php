...
<?php $__env->startSection('content'); ?>
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 col-lg-4 pt-4">
                <div class="main-heading">
                    ...
                    Cheap Flights to <?php echo e($city); ?>
        ...
        <div class="container review-section">
            <h2>97% Of <?php echo e($city); ?> Travelers Recommend TRIPGARE Tickets</h2>
            <div class="stars">
        ...
        <div class="container">
            <div class="content-section">
                <h3>
                    Flight Tickets to <?php echo e($city); ?>, Nigeria
                </h3>
                <p>
                    Finding cheap flights to <?php echo e($city); ?> online can be quite challenging. TRIPGARE Tickets can do
                    all
                    the footwork for you
                    to save time and money. Our Travel Agents manually put together the best-priced airfares to the
                    <?php echo e($city); ?> with
                    the most convenient itineraries to offer you cheap tickets to <?php echo e($city); ?>. Fly to
                    <?php echo e($city); ?> with our special
                    negotiated online and offline airfares unavailable online and save on your flight to
                    <?php echo e($city); ?>. Our contracted
                    airline rates give you access to the best flight deals among hundreds of different airlines. The times
                    when
                    the travel was cheap are back! For affordable travel to <?php echo e($city); ?>, call to speak to a travel
                    agent or submit a
            ...
            <div class="row content-section">
                <div class="col-md-6">
                    <h3>
                        Find Cheap Flights to <?php echo e($city); ?>
                    ...
                    <p>
                        ...
                        tickets
                        to
                        <?php echo e($city); ?> for a limited time only. Contact our agents to learn more about all our
                ...
                <div class="col-md-6">
                    ...
                    <p>
                        ...
                        tickets to <?php echo e($city); ?> and other destinations. Through over a decade of industry
                        experience, we have partnered
                        with more than 500 major airlines to offer our clients various travel options to the
                        <?php echo e($city); ?> and beyond.
                        Needless to say, TRIPGARE Tickets is among the first to receive exclusive promotions and limited
                        deals
                        to
                        <?php echo e($city); ?>. Feel free to browse through our website and stay connected through our
                        newsletter and social
                        media accounts to be the first to know about the best available <?php echo e($city); ?> flight deals.
                    </p>
                </div>
            </div>
        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <input class="form-control departureDateR" placeholder="Departure Date" name="start_date" required=""
                                                    type="date" value="<?php echo e(\Carbon\Carbon::now()->format('Y-m-d')); ?>"  min="<?php echo e(\Carbon\Carbon::now()->format('Y-m-d')); ?>"/>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/tripgwdd/flight.tripgare.com/themes/BC/News/Views/frontend/cheap-flights/trip.blade.php ENDPATH**/ ?>