				...
				<div class="tw-shrink-0 tw-grow tw-basis-auto">
					...
					<div class="tw-relative tw-min-h-[460px]">
						...
						<div class="block-wrapper tw-relative !tw-mt-0 tw-flex tw-flex-col tw-justify-between !tw-pt-0 klckwT">
							...
							<div class="tw-flex">
								<div class="tw-w-full">
									<h1 class="sc-156dc327-0 jDJjAw bold tw-text-center">Cheap Flights to <?php echo e($city); ?></h1>
																...
																<article class="tw-mx-auto tw-my-0">
																	<div style="padding:15px 20px 12px">
																		...
																		<div class="offer-ends text-sm tw-text-center
																			...
																			<div>
																				ENDS<!-- --> <!-- Nov 18  --> <?php echo e(\Carbon\Carbon::now()->addDays(2)->format('d M')); ?><!-- --> 
																			</div>
																		</div>
																	</div>
																</article>
																				...
																				<div class="tw-relative tw-flex">
																					<div>
                                                                                        ...
                                                                                        <span class="price-label-price tw-cursor-pointer" id="vj_price" data-qa-quote-form="special-fare">
																							<?php if(isset($converteddisPrice)): ?>
																							<?php echo e(str_replace(' ', '', $converteddisPrice)); ?>
																					...
																					<div class="semibold tw-text-left" style="margin-left:10px">
																						<div class="" style="color: #ff7d01;font-size:18px">
																							<s>
																								<?php if(isset($convertedPrice)): ?>
																								<?php echo e(str_replace(' ', '', $convertedPrice)); ?>
												...
												<div class="dashed tw-bg-background" style="padding-top:10px">
													<div class="shadow tw-w-full tw-max-w-[270px] tw-rounded tw-bg-background dashed wrap-15-20 abt-center-landing tw-w-[240px]">
														...
														<div class="offer-ends text-sm tw-text-center
															...
															<div class="m-r-xs"><strong>Limited-time Offer!</strong></div>
															<div>
																ENDS<!-- --> <!-- --> <?php echo e(\Carbon\Carbon::now()->addDays(2)->format('d M')); ?><!-- --> 
															</div>
														</div>
													</div>
													<div class="pos-rltg">
														...
														<div class="tw-relative tw-mb-8 tw-mt-48">
															<div class="tw-px-20">
																...
																<span class="price-label-price tw-cursor-pointer" id="vj_price2" data-qa-quote-form="special-fare"> <?php if(isset($converteddisPrice)): ?>
																			<?php echo e(str_replace(' ', '', $converteddisPrice)); ?>

																		<?php else: ?>
																			0
																		<?php endif; ?></span><span class="price-label-asterisk  " >*</span></div>
																	</div>
...
<div class="modal" id="popupModal">
    <div class="modal-content position-relative">
        ...
        <div class="row g-0">
            <!-- Left Image -->
            <div class="col-md-6">
                <img src="<?php echo e(asset('public/images/trip_new/howItWorksBG.jpg')); ?>" 
                                ...
                                <div class="row justify-content-center" style="margin-top: 30px;">
                                    <div class="col-md-3 offer-item ">
                                        <!--<img alt="24/7 Live Service Icon" height="80" class="img_s" id="img_s"
                                            src="<?php echo e(asset('public/images/trip/7.png')); ?>"
                                            width="90" >-->
                                    ...
                                    <div class="col-md-3 offer-item">
                                        <!--<img alt="Lowest Airfare Guarantee Icon" height="80" class="img_s" id="img_s"
                                            src="<?php echo e(asset('public/images/trip/8.png')); ?>"
                                            width="90" />-->
                                    ...
                                    <div class="col-md-3 offer-item">
                                        <!--<img alt="Personalized Expert Advice Icon" height="80" class="img_s" id="img_s"
                                            src="<?php echo e(asset('public/images/trip/3.png')); ?>"
                                            width="90"  />-->
                                    ...
                                    <div class="col-md-3 offer-item">
                                       <!-- <img alt="Exclusive Negotiated Discounts Icon" height="80" class="img_s" id="img_s"
                                            src="<?php echo e(asset('public/images/trip/4.png')); ?>"
                                            width="90" />-->
            ...
            <div class="carousel-indicators">
					...
					<section class="block-wrapper m-t-lg">
						<div>
							<div class="tw-mb-32 desktop:tw-mb-16">
								<h2 class="tw-mb-[15px] tw-text-center tw-text-[20px] tw-leading-[21px] desktop:tw-text-left desktop:tw-leading-[31px]">Flight Tickets to <?php echo e($city); ?>, Nigeria</h2>
								<p class="tw-text-justify tw-font-normal tw-leading-[21px]">Finding cheap flights to <?php echo e($city); ?> online can be quite challenging. Tripgare Tickets can do all the footwork for you to save time and money. Our Travel Agents manually put together the best-priced airfares to the <?php echo e($city); ?> with the most convenient itineraries to offer you cheap tickets to <?php echo e($city); ?>. Fly to <?php echo e($city); ?> with our special negotiated online and offline airfares unavailable online and save on your flight to <?php echo e($city); ?>. Our contracted airline rates give you access to the best flight deals among hundreds of different airlines. The times when the travel was cheap are back! For affordable travel to <?php echo e($city); ?>, call to speak to a travel agent or submit a callback request and well contact you back asap.</p>
							</div>
							<div class="tw-block tablet:tw-flex desktop:-tw-mx-24">
								<div class="tw-w-full tablet:tw-w-1/2 desktop:tw-px-24">
									<div class="tw-mb-32 desktop:tw-mb-16">
										<h2 class="tw-mb-[15px] tw-text-center tw-text-[20px] tw-leading-[21px] desktop:tw-text-left desktop:tw-leading-[31px]">Find Cheap Flights to <?php echo e($city); ?></h2>
										<p class="tw-text-justify tw-font-normal tw-leading-[21px]">Tripgare Tickets Travel Agents will help you choose and book the most convenient and coordinated flights with smooth connections for an itinerary that suits your individual travel needs. Thanks to our extensive variety of private, specially negotiated contracts with the airlines, cheap airfares to <?php echo e($city); ?> are available during any travel season. Currently Tripgare Tickets is offering sale on airline tickets to <?php echo e($city); ?> for a limited time only. Contact our agents to learn more about all our unpublished flight deals and take advantage of these special bargains by booking now!			</p>
									</div>
								</div>
								<div class="tw-w-full tablet:tw-w-1/2 desktop:tw-px-24">
									<div class="tw-mb-32 desktop:tw-mb-16">
										<h2 class="tw-mb-[15px] tw-text-center tw-text-[20px] tw-leading-[21px] desktop:tw-text-left desktop:tw-leading-[31px]">About <?php echo e($city); ?> Travel</h2>
										<p class="tw-text-justify tw-font-normal tw-leading-[21px]">Tripgare Tickets is a unique fusion of an airline ticket consolidator (wholesaler) with a travel agency (retailer). Our unprecedented business model was created so that our customers get the best of both worlds: discounted airfares negotiated at wholesale prices and a personalized approach for every single request! We are committed to providing our valued customers with only the best and reasonably-priced tickets to <?php echo e($city); ?> and other destinations. Through over a decade of industry experience, we have partnered with more than 500 major airlines to offer our clients various travel options to the <?php echo e($city); ?> and beyond. Needless to say, Tripgare Tickets is among the first to receive exclusive promotions and limited deals to <?php echo e($city); ?>. Feel free to browse through our website and stay connected through our newsletter and social media accounts to be the first to know about the best available <?php echo e($city); ?> flight deals.</p>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="bravo-list-news">
					...
					<div class="container custom-container" style="padding: 0;margin:0; ">
						...
						<h4 id="c768">Lowest All-in Round-trip Airfares to <b><?php echo e($city); ?></b></h4>
								...
								<div class="deals-grid">
									<?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<a href="<?php echo e(route('cheap-flight', str_replace(' ', '-', $city->city))); ?>"
											class="deal-link">
											<div class="deal-item"><?php echo e($city->city); ?><span
													class='currencyvalue'><?php echo e(str_replace(' ', '', $city->discount_price)); ?>
										...
										<div class="b-b-grey tw-relative">
										   <span class="text-lg bold">
											  <div class="tw-relative">
												...
												<span class="price-label-price" style="font-size:19px;"> <?php if(isset($converteddisPrice)): ?>
														<?php echo e(str_replace(' ', '', $converteddisPrice)); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/tripgwdd/flight.tripgare.com/themes/BC/News/Views/frontend/cheap-flights/trip_new.blade.php ENDPATH**/ ?>